...
function TimeOrbitTest{
    ...
    local meanLongitiudeAtEpochIfBurnConductedAtAp to UnsignedModular(
        meanAnomalyAtEpochIfBurnConductedAtAP + targetArguementOfPeriapsis + targetMeanLongitudeAtEpoch, 360).
    ...
    local finalPeriapsis to 2*finalSemiMajorAxis - currentApoapsis.
